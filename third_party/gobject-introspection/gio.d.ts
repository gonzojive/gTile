...
export interface AppInfo {
  ...
  'supports-files': boolean;
  'supports-uris': boolean;
...
export interface DtlsConnection {
  ...
  'peer-certificate-errors': any;
  'rehandshake-mode': any;
  ...
  get_channel_binding_data(type: TlsChannelBindingType, data?: number[]): boolean;
...
export class ListStore extends GObject.Object {
  ...
  find(item: GObject.Object, position?: number): boolean;
  find_with_equal_func(item: GObject.Object, equal_func: GLib.EqualFunc, position?: number): boolean;
...
export class TlsConnection extends IOStream {
  ...
  get_binding_data(type: TlsChannelBindingType, data: number[]): boolean;
  handshake(...args: any[]): any;
  handshake_async(...args: any[]): any;
  handshake_finish(...args: any[]): any;
}
...
export class DtlsConnectionInterface {
  ...
  static get_binding_data: (conn: any, type: TlsChannelBindingType, data: number[]) => boolean;
}
...
export class MemoryMonitorInterface {
  static g_iface: GObject.TypeInterface;
  static low_memory_warning: (monitor: any, level: MemoryMonitorWarningLevel) => void;
}
...
export class ThreadedResolverClass {
  static parent_class: ResolverClass;
}
...
export class TlsConnectionClass {
  ...
  static get_binding_data: (conn: TlsConnection, type: TlsChannelBindingType, data: number[]) => boolean;
  static padding: object[];
}
...
export class XdpDocuments {}
export class XdpDocumentsIface {
  static parent_iface: GObject.TypeInterface;
  static handle_add: (object: XdpDocuments, invocation: DBusMethodInvocation, fd_list: UnixFDList, arg_o_path_fd: GLib.Variant, arg_reuse_existing: boolean, arg_persistent: boolean) => boolean;
  static handle_add_full: (object: XdpDocuments, invocation: DBusMethodInvocation, fd_list: UnixFDList, arg_o_path_fds: GLib.Variant, arg_flags: number, arg_app_id: string, arg_permissions: string) => boolean;
  static handle_add_named: (object: XdpDocuments, invocation: DBusMethodInvocation, fd_list: UnixFDList, arg_o_path_parent_fd: GLib.Variant, arg_filename: string, arg_reuse_existing: boolean, arg_persistent: boolean) => boolean;
  static handle_add_named_full: (object: XdpDocuments, invocation: DBusMethodInvocation, fd_list: UnixFDList, arg_o_path_fd: GLib.Variant, arg_filename: string, arg_flags: number, arg_app_id: string, arg_permissions: string) => boolean;
  static handle_delete: (object: XdpDocuments, invocation: DBusMethodInvocation, arg_doc_id: string) => boolean;
  static handle_get_mount_point: (object: XdpDocuments, invocation: DBusMethodInvocation) => boolean;
  static handle_grant_permissions: (object: XdpDocuments, invocation: DBusMethodInvocation, arg_doc_id: string, arg_app_id: string, arg_permissions: string) => boolean;
  static handle_info: (object: XdpDocuments, invocation: DBusMethodInvocation, arg_doc_id: string) => boolean;
  static handle_list: (object: XdpDocuments, invocation: DBusMethodInvocation, arg_app_id: string) => boolean;
  static handle_lookup: (object: XdpDocuments, invocation: DBusMethodInvocation, arg_filename: string) => boolean;
  static handle_revoke_permissions: (object: XdpDocuments, invocation: DBusMethodInvocation, arg_doc_id: string, arg_app_id: string, arg_permissions: string) => boolean;
  static get_version: (object: XdpDocuments) => number;
}
export class XdpDocumentsProxy {
  static parent_instance: DBusProxy;
  static priv: XdpDocumentsProxyPrivate;
}
export class XdpDocumentsProxyClass {
  static parent_class: DBusProxyClass;
}
export class XdpDocumentsProxyPrivate {}
export class XdpDocumentsSkeleton {
  static parent_instance: DBusInterfaceSkeleton;
  static priv: XdpDocumentsSkeletonPrivate;
}
export class XdpDocumentsSkeletonClass {
  static parent_class: DBusInterfaceSkeletonClass;
}
export class XdpDocumentsSkeletonPrivate {}
export class XdpOpenURI {}
export class XdpOpenURIIface {
  static parent_iface: GObject.TypeInterface;
  static handle_open_directory: (object: XdpOpenURI, invocation: DBusMethodInvocation, fd_list: UnixFDList, arg_parent_window: string, arg_fd: GLib.Variant, arg_options: GLib.Variant) => boolean;
  static handle_open_file: (object: XdpOpenURI, invocation: DBusMethodInvocation, fd_list: UnixFDList, arg_parent_window: string, arg_fd: GLib.Variant, arg_options: GLib.Variant) => boolean;
  static handle_open_uri: (object: XdpOpenURI, invocation: DBusMethodInvocation, arg_parent_window: string, arg_uri: string, arg_options: GLib.Variant) => boolean;
  static get_version: (object: XdpOpenURI) => number;
}
export class XdpOpenURIProxy {
  static parent_instance: DBusProxy;
  static priv: XdpOpenURIProxyPrivate;
}
export class XdpOpenURIProxyClass {
  static parent_class: DBusProxyClass;
}
export class XdpOpenURIProxyPrivate {}
export class XdpOpenURISkeleton {
  static parent_instance: DBusInterfaceSkeleton;
  static priv: XdpOpenURISkeletonPrivate;
}
export class XdpOpenURISkeletonClass {
  static parent_class: DBusInterfaceSkeletonClass;
}
export class XdpOpenURISkeletonPrivate {}
export class XdpProxyResolver {}
export class XdpProxyResolverIface {
  static parent_iface: GObject.TypeInterface;
  static handle_lookup: (object: XdpProxyResolver, invocation: DBusMethodInvocation, arg_uri: string) => boolean;
  static get_version: (object: XdpProxyResolver) => number;
}
export class XdpProxyResolverProxy {
  static parent_instance: DBusProxy;
  static priv: XdpProxyResolverProxyPrivate;
}
export class XdpProxyResolverProxyClass {
  static parent_class: DBusProxyClass;
}
export class XdpProxyResolverProxyPrivate {}
export class XdpProxyResolverSkeleton {
  static parent_instance: DBusInterfaceSkeleton;
  static priv: XdpProxyResolverSkeletonPrivate;
}
export class XdpProxyResolverSkeletonClass {
  static parent_class: DBusInterfaceSkeletonClass;
}
export class XdpProxyResolverSkeletonPrivate {}
export class XdpTrash {}
export class XdpTrashIface {
  static parent_iface: GObject.TypeInterface;
  static handle_trash_file: (object: XdpTrash, invocation: DBusMethodInvocation, fd_list: UnixFDList, arg_fd: GLib.Variant) => boolean;
  static get_version: (object: XdpTrash) => number;
}
export class XdpTrashProxy {
  static parent_instance: DBusProxy;
  static priv: XdpTrashProxyPrivate;
}
export class XdpTrashProxyClass {
  static parent_class: DBusProxyClass;
}
export class XdpTrashProxyPrivate {}
export class XdpTrashSkeleton {
  static parent_instance: DBusInterfaceSkeleton;
  static priv: XdpTrashSkeletonPrivate;
}
export class XdpTrashSkeletonClass {
  static parent_class: DBusInterfaceSkeletonClass;
}
export class XdpTrashSkeletonPrivate {}
...
export class _FreedesktopDBus {}
export class _FreedesktopDBusIface {
  static parent_iface: GObject.TypeInterface;
  static handle_add_match: (object: any, invocation: DBusMethodInvocation, arg_rule: string) => boolean;
  static handle_get_connection_selinux_security_context: (object: any, invocation: DBusMethodInvocation, arg_name: string) => boolean;
  static handle_get_connection_unix_process_id: (object: any, invocation: DBusMethodInvocation, arg_name: string) => boolean;
  static handle_get_connection_unix_user: (object: any, invocation: DBusMethodInvocation, arg_name: string) => boolean;
  static handle_get_id: (object: any, invocation: DBusMethodInvocation) => boolean;
  static handle_get_name_owner: (object: any, invocation: DBusMethodInvocation, arg_name: string) => boolean;
  static handle_hello: (object: any, invocation: DBusMethodInvocation) => boolean;
  static handle_list_activatable_names: (object: any, invocation: DBusMethodInvocation) => boolean;
  static handle_list_names: (object: any, invocation: DBusMethodInvocation) => boolean;
  static handle_list_queued_owners: (object: any, invocation: DBusMethodInvocation, arg_name: string) => boolean;
  static handle_name_has_owner: (object: any, invocation: DBusMethodInvocation, arg_name: string) => boolean;
  static handle_release_name: (object: any, invocation: DBusMethodInvocation, arg_name: string) => boolean;
  static handle_reload_config: (object: any, invocation: DBusMethodInvocation) => boolean;
  static handle_remove_match: (object: any, invocation: DBusMethodInvocation, arg_rule: string) => boolean;
  static handle_request_name: (object: any, invocation: DBusMethodInvocation, arg_name: string, arg_flags: number) => boolean;
  static handle_start_service_by_name: (object: any, invocation: DBusMethodInvocation, arg_name: string, arg_flags: number) => boolean;
  static handle_update_activation_environment: (object: any, invocation: DBusMethodInvocation, arg_environment: GLib.Variant) => boolean;
  static name_acquired: (object: any, arg_name: string) => void;
  static name_lost: (object: any, arg_name: string) => void;
  static name_owner_changed: (object: any, arg_name: string, arg_old_owner: string, arg_new_owner: string) => void;
}
export class _FreedesktopDBusProxy {
  static parent_instance: DBusProxy;
  static priv: any;
}
export class _FreedesktopDBusProxyClass {
  static parent_class: DBusProxyClass;
}
export class _FreedesktopDBusProxyPrivate {}
export class _FreedesktopDBusSkeleton {
  static parent_instance: DBusInterfaceSkeleton;
  static priv: any;
}
export class _FreedesktopDBusSkeletonClass {
  static parent_class: DBusInterfaceSkeletonClass;
}
export class _FreedesktopDBusSkeletonPrivate {}
...
export function app_info_get_default_for_type(content_type: string, must_support_uris: boolean): any | null;
export function app_info_get_default_for_uri_scheme(uri_scheme: string): any | null;
...
export function dbus_address_escape_value(_string: string): string;
...
export function dbus_error_set_dbus_error(error: GLib.Error, dbus_error_name: string, dbus_error_message: string, format: string | null, ...args: any[]): void;
export function dbus_error_set_dbus_error_valist(error: GLib.Error, dbus_error_name: string, dbus_error_message: string, format: string | null, var_args: any): void;
...
export function dbus_is_address(_string: string): boolean;
export function dbus_is_guid(_string: string): boolean;
export function dbus_is_interface_name(_string: string): boolean;
export function dbus_is_member_name(_string: string): boolean;
export function dbus_is_name(_string: string): boolean;
export function dbus_is_supported_address(_string: string): boolean;
export function dbus_is_unique_name(_string: string): boolean;
...
export function memory_monitor_dup_default(): any;
...
export type DBusSignalCallback = (connection: DBusConnection, sender_name: string | null, object_path: string, interface_name: string, signal_name: string, parameters: GLib.Variant, user_data: object | null) => void;
