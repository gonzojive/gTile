...
export const TRACE_CURRENT_TIME: number;
...
export class Array {
  ...
  static steal(array: object[], len?: number): object | null;
...
export class BookmarkFile {
  ...
  get_application_info(uri: string, name: string, exec?: string, count?: number, stamp?: DateTime): boolean;
...
export class ByteArray {
  ...
  static steal(array: number[], len?: number): number;
...
export class KeyFile {
  ...
  set_locale_string(group_name: string, key: string, locale: string, _string: string): void;
  set_locale_string_list(group_name: string, key: string, locale: string, list: string[], length: number): void;
  set_string(group_name: string, key: string, _string: string): void;
...
export class MarkupParseContext {
  ...
  get_position(line_number?: number, char_number?: number): void;
...
export class Regex {
  ...
  match(_string: string, match_options: RegexMatchFlags, match_info?: MatchInfo): boolean;
  match_all(_string: string, match_options: RegexMatchFlags, match_info?: MatchInfo): boolean;
  match_all_full(_string: string[], string_len: number, start_position: number, match_options: RegexMatchFlags, match_info?: MatchInfo): boolean;
  match_full(_string: string[], string_len: number, start_position: number, match_options: RegexMatchFlags, match_info?: MatchInfo): boolean;
  ref(): Regex;
  replace(_string: string[], string_len: number, start_position: number, replacement: string, match_options: RegexMatchFlags): string;
  replace_eval(_string: string[], string_len: number, start_position: number, match_options: RegexMatchFlags, _eval: RegexEvalCallback, user_data: object | null): string;
  replace_literal(_string: string[], string_len: number, start_position: number, replacement: string, match_options: RegexMatchFlags): string;
  split(_string: string, match_options: RegexMatchFlags): string[];
  split_full(_string: string[], string_len: number, start_position: number, match_options: RegexMatchFlags, max_tokens: number): string[];
  unref(): void;
  static check_replacement(replacement: string, has_references?: boolean): boolean;
  static error_quark(): Quark;
  static escape_nul(_string: string, length: number): string;
  static escape_string(_string: string[], length: number): string;
  static match_simple(pattern: string, _string: string, compile_options: RegexCompileFlags, match_options: RegexMatchFlags): boolean;
  static split_simple(pattern: string, _string: string, compile_options: RegexCompileFlags, match_options: RegexMatchFlags): string[];
}
export class SList {
  static data: object;
  static next: SList;
...
export class Source {
  ...
  set_dispose_function(dispose: SourceDisposeFunc): void;
...
export class StringChunk {
  clear(): void;
  free(): void;
  insert(_string: string): string;
  insert_const(_string: string): string;
  insert_len(_string: string, len: number): string;
...
export class Uri {
  ...
  get_user(): string;
  get_userinfo(): string;
  parse_relative(uri_string: string, flags: UriFlags): Uri;
  ref(): Uri;
  to_string(): string;
  ...
  static error_quark(): Quark;
  static escape_bytes(unescaped: number[], length: number, reserved_chars_allowed: string | null): string;
  ...
  static join(flags: UriFlags, scheme: string, userinfo: string | null, host: string | null, port: number, path: string, query: string | null, fragment: string | null): string;
  static join_with_user(flags: UriFlags, scheme: string, user: string | null, password: string | null, auth_params: string | null, host: string | null, port: number, path: string, query: string | null, fragment: string | null): string;
  ...
  static parse_scheme(uri: string): string;
  static peek_scheme(uri: string): string;
  static resolve_relative(base_uri_string: string | null, uri_string: string, flags: UriFlags): string;
  static split(uri_string: string, flags: UriFlags, scheme?: string, userinfo?: string, host?: string, port?: number, path?: string, query?: string, fragment?: string): boolean;
  static split_network(uri_string: string, flags: UriFlags, scheme?: string, host?: string, port?: number): boolean;
  static split_with_user(uri_string: string, flags: UriFlags, scheme?: string, user?: string, password?: string, auth_params?: string, host?: string, port?: number, path?: string, query?: string, fragment?: string): boolean;
...
export class Variant {
  ...
  print_string(_string: String | null, type_annotate: boolean): String;
  ref(): Variant;
  ref_sink(): Variant;
  store(data: object): void;
  take_ref(): Variant;
  unref(): void;
  static is_object_path(_string: string): boolean;
  static is_signature(_string: string): boolean;
...
export class VariantType {
  ...
  static string_scan(_string: string, limit: string | null, endptr?: string): boolean;
}
...
export function bit_storage(_number: number): number;
...
export function byte_array_steal(array: number[], len: number): number;
...
export function clear_list(list_ptr: List, destroy: DestroyNotify | null): void;
export function clear_pointer(pp: object, destroy: DestroyNotify): void;
export function clear_slist(slist_ptr: SList, destroy: DestroyNotify | null): void;
...
export function file_set_contents_full(filename: any, contents: number[], length: number, flags: FileSetContentsFlags, mode: number): boolean;
...
export function find_program_in_path(program: any): any | null;
...
export function intern_static_string(_string: string | null): string;
export function intern_string(_string: string | null): string;
...
export function parse_debug_string(_string: string | null, keys: DebugKey[], nkeys: number): number;
...
export function pattern_match(pspec: PatternSpec, string_length: number, _string: string, string_reversed: string | null): boolean;
export function pattern_match_simple(pattern: string, _string: string): boolean;
export function pattern_match_string(pspec: PatternSpec, _string: string): boolean;
...
export function quark_from_static_string(_string: string | null): Quark;
export function quark_from_string(_string: string | null): Quark;
export function quark_to_string(quark: Quark): string;
export function quark_try_string(_string: string | null): Quark;
...
export function regex_escape_nul(_string: string, length: number): string;
export function regex_escape_string(_string: string[], length: number): string;
export function regex_match_simple(pattern: string, _string: string, compile_options: RegexCompileFlags, match_options: RegexMatchFlags): boolean;
export function regex_split_simple(pattern: string, _string: string, compile_options: RegexCompileFlags, match_options: RegexMatchFlags): string[];
...
export function set_user_dirs(first_dir_type: string, ...args: any[]): void;
...
export function snprintf(_string: string, n: number, format: string, ...args: any[]): number;
...
export function sprintf(_string: string, format: string, ...args: any[]): number;
...
export function str_tokenize_and_fold(_string: string, translit_locale: string | null, ascii_alternates: string[]): string[];
export function strcanon(_string: string, valid_chars: string, substitutor: number): string;
export function strcasecmp(s1: string, s2: string): number;
export function strchomp(_string: string): string;
export function strchug(_string: string): string;
...
export function strdelimit(_string: string, delimiters: string | null, new_delimiter: number): string;
export function strdown(_string: string): string;
...
export function strreverse(_string: string): string;
...
export function strsplit(_string: string, delimiter: string, max_tokens: number): string[];
export function strsplit_set(_string: string, delimiters: string, max_tokens: number): string[];
...
export function strup(_string: string): string;
...
export function trace_mark(begin_time_nsec: number, duration_nsec: number, group: string, name: string, message_format: string, ...args: any[]): void;
...
export function unicode_canonical_ordering(_string: number, len: number): void;
...
export function uri_escape_bytes(unescaped: number[], length: number, reserved_chars_allowed: string | null): string;
...
export function uri_join(flags: UriFlags, scheme: string, userinfo: string | null, host: string | null, port: number, path: string, query: string | null, fragment: string | null): string;
export function uri_join_with_user(flags: UriFlags, scheme: string, user: string | null, password: string | null, auth_params: string | null, host: string | null, port: number, path: string, query: string | null, fragment: string | null): string;
...
export function uri_peek_scheme(uri: string): string;
export function uri_resolve_relative(base_uri_string: string | null, uri_string: string, flags: UriFlags): string;
export function uri_split(uri_string: string, flags: UriFlags, scheme: string, userinfo: string, host: string, port: number, path: string, query: string, fragment: string): boolean;
export function uri_split_network(uri_string: string, flags: UriFlags, scheme: string, host: string, port: number): boolean;
export function uri_split_with_user(uri_string: string, flags: UriFlags, scheme: string, user: string, password: string, auth_params: string, host: string, port: number, path: string, query: string, fragment: string): boolean;
...
export function variant_is_object_path(_string: string): boolean;
export function variant_is_signature(_string: string): boolean;
...
export function variant_type_string_scan(_string: string, limit: string | null, endptr: string): boolean;
export function vasprintf(_string: string, format: string, args: any): number;
export function vfprintf(file: object, format: string, args: any): number;
export function vprintf(format: string, args: any): number;
export function vsnprintf(_string: string, n: number, format: string, args: any): number;
export function vsprintf(_string: string, format: string, args: any): number;
...
export type PrintFunc = (_string: string) => void;
