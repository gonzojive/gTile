...
export function boxed_type_register_static(name: string, boxed_copy: BoxedCopyFunc, boxed_free: BoxedFreeFunc): any;
...
export function enum_complete_type_info(g_enum_type: any, info: TypeInfo, const_values: EnumValue): void;
...
export function enum_register_static(name: string, const_static_values: EnumValue): any;
export function enum_to_string(g_enum_type: any, value: number): string;
export function flags_complete_type_info(g_flags_type: any, info: TypeInfo, const_values: FlagsValue): void;
...
export function flags_register_static(name: string, const_static_values: FlagsValue): any;
...
export function param_type_register_static(name: string, pspec_info: ParamSpecTypeInfo): any;
...
export function signal_chain_from_overridden_handler(instance: TypeInstance, ...args: any[]): void;
...
export function signal_new(signal_name: string, itype: any, signal_flags: SignalFlags, class_offset: number, accumulator: SignalAccumulator, accu_data: object | null, c_marshaller: SignalCMarshaller | null, return_type: any, n_params: number, ...args: any[]): number;
export function signal_new_class_handler(signal_name: string, itype: any, signal_flags: SignalFlags, class_handler: Callback, accumulator: SignalAccumulator, accu_data: object | null, c_marshaller: SignalCMarshaller | null, return_type: any, n_params: number, ...args: any[]): number;
export function signal_new_valist(signal_name: string, itype: any, signal_flags: SignalFlags, class_closure: Closure, accumulator: SignalAccumulator, accu_data: object | null, c_marshaller: SignalCMarshaller | null, return_type: any, n_params: number, args: any): number;
export function signal_newv(signal_name: string, itype: any, signal_flags: SignalFlags, class_closure: Closure | null, accumulator: SignalAccumulator | null, accu_data: object | null, c_marshaller: SignalCMarshaller | null, return_type: any, n_params: number, param_types: any[]): number;
export function signal_override_class_closure(signal_id: number, instance_type: any, class_closure: Closure): void;
export function signal_override_class_handler(signal_name: string, instance_type: any, class_handler: Callback): void;
export function signal_parse_name(detailed_signal: string, itype: any, signal_id_p: number, detail_p: GLib.Quark, force_detail_quark: boolean): boolean;
...
export function signal_set_va_marshaller(signal_id: number, instance_type: any, va_marshaller: SignalCVaMarshaller): void;
...
export function signal_type_cclosure_new(itype: any, struct_offset: number): Closure;
...
export function type_add_interface_static(instance_type: any, interface_type: any, info: InterfaceInfo): void;
export function type_check_class_cast(g_class: TypeClass, is_a_type: any): TypeClass;
export function type_check_class_is_a(g_class: TypeClass, is_a_type: any): boolean;
export function type_check_instance(instance: TypeInstance): boolean;
export function type_check_instance_cast(instance: TypeInstance, iface_type: any): TypeInstance;
export function type_check_instance_is_a(instance: TypeInstance, iface_type: any): boolean;
export function type_check_instance_is_fundamentally_a(instance: TypeInstance, fundamental_type: any): boolean;
...
export function type_interface_peek(instance_class: TypeClass, iface_type: any): TypeInterface;
...
export function type_register_fundamental(type_id: any, type_name: string, info: TypeInfo, finfo: TypeFundamentalInfo, flags: TypeFlags): any;
export function type_register_static(parent_type: any, type_name: string, info: TypeInfo, flags: TypeFlags): any;
export function type_register_static_simple(parent_type: any, type_name: string, class_size: number, class_init: ClassInitFunc, instance_size: number, instance_init: InstanceInitFunc, flags: TypeFlags): any;
...
export function type_set_qdata(type: any, quark: GLib.Quark, data: object | null): void;
...
export function value_register_transform_func(src_type: any, dest_type: any, transform_func: ValueTransform): void;
...
export type TypePluginCompleteInterfaceInfo = (plugin: any, instance_type: any, interface_type: any, info: InterfaceInfo) => void;
export type TypePluginCompleteTypeInfo = (plugin: any, g_type: any, info: TypeInfo, value_table: TypeValueTable) => void;
export type TypePluginUnuse = (plugin: any) => void;
export type TypePluginUse = (plugin: any) => void;
export type VaClosureMarshal = (closure: Closure, return_value: Value | null, instance: TypeInstance, args: any, marshal_data: object | null, n_params: number, param_types: any[]) => void;
