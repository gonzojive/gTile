...
export function object_info_find_method_using_interfaces(info: ObjectInfo, name: string, implementor: ObjectInfo): FunctionInfo | null;
...
export function object_info_find_vfunc_using_interfaces(info: ObjectInfo, name: string, implementor: ObjectInfo): VFuncInfo | null;
...
export function object_info_get_get_value_function_pointer(info: ObjectInfo): ObjectInfoGetValueFunction | null;
...
export function object_info_get_ref_function_pointer(info: ObjectInfo): ObjectInfoRefFunction | null;
export function object_info_get_set_value_function(info: ObjectInfo): string | null;
export function object_info_get_set_value_function_pointer(info: ObjectInfo): ObjectInfoSetValueFunction | null;
...
export function object_info_get_unref_function_pointer(info: ObjectInfo): ObjectInfoUnrefFunction | null;
